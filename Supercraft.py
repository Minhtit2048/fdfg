...
Oak_texture  = load_texture('assets/Oak_log_block.png')
wood_texture  = load_texture('assets/wood_planks_block.png')
	...
	def input(self,key):
		if self.hovered:
			if key == 'right mouse down':
				...
				if block_pick == 8: voxel = Voxel(position=self.position + mouse.normal, texture= stone_brick_texture)
